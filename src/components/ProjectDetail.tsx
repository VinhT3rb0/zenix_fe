...
const columns = [
  ...
  },
  {
    ...
    dataIndex: 'status',
    key: 'status',
    render: (text: string) => <Tag color={text === 'Done' ? 'green' : 'volcano'}>{text}</Tag>,
  },
];
...
function ProjectDetail() {
  ...
  const addSheet = () => {
    const newSheet: Sheet = {
      ...
      name: `Bộ phận ${sheets.length + 1}`,
      data: [
        {
          key: '1',
          task: 'Công việc mẫu',
          assignee: 'Người dùng 1',
          progress: '50%',
          status: 'In Progress'
        }
      ]
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1440px', margin: '0 auto' }}>
      <Row gutter={24}>
        ...
        <Col span={8}>
          <Card
            title={<><AppstoreOutlined /> Thông tin dự án</>}
            bordered={false}
          ...
          >
            <Descriptions column={1} bordered>
              ...
              <Descriptions.Item label="Người tạo">{project?.user}</Descriptions.Item>
